...
foreach $file (@files)
{
  ...
  if(-e "$dir/$file/$file/cluster/annotation/")
  {
  

    if(-e "$dir/$file/$file/cluster/annotation/formated_result/")
    {
    	system("rm -R $dir/$file/$file/cluster/annotation/formated_result/");
    }
  
    mkdir("$dir/$file/$file/cluster/annotation/formated_result/", 0777);

    my $dossier="$dir/$file/$file/cluster/annotation/result/";
    ...
    foreach $fichier (@list)
    {
		...
		my @tab = () ;
		my $compteur = 0 ;
		open(AK,"$dir/$file/$file/cluster/annotation/result/$fichier") or die "impossible d'ouvrir $dir/$file/$file/cluster/annotation/result/$fichier \n" ;
		$ligne = <AK> ;
		my $total_puce = 0 ;
		my $total_cluster = 0 ;
		while(<AK>)
		...
		open(RES,">$dir/$file/$file/cluster/annotation/formated_result/cluster$number.txt") ;
